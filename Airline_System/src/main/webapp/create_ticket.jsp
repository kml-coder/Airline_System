...
<%
    ...
    System.getenv("DB_PASSWORD")
        ...
        String ticketNumber = acc_id + flight_number + "T" + System.currentTimeMillis();

        pstmt = con.prepareStatement("INSERT INTO ticket_economy_business_first_changes_buys (ticket_number, acc_id, flight_num, passenger_first, passenger_last, id_number, seat_number, class, purchase_date_time, booking_fee, total_fare) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW(), 25, 400)");
