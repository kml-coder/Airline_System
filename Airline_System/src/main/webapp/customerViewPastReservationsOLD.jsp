...
<%
	...
	if (!rs.next()) {
		out.println("No past flights with this username! " + username + " <a href='customerwelcome.jsp'>go back</a>");
		...
		if (!rs2.next()) {
			out.println("No past flights! <a href='customerwelcome.jsp'>go back</a>");
		} else {
			do {
				...
				out.println("<h3>ticket number: " + ticket_number + "</h3> <h5>flight number: " + flight_num + "</h5> <h5> account id: " + acc_id + "</h5><h5> total fare: " + total_fare + " " + "</h5><h5> first name: " 
				+ passenger_first + "</h5><h5> last name: " + passenger_last + "</h5><h5> purchase date and time: " + purchase_date_time + "</h5><h5> booking fee: " + booking_fee + 
				 "</h5><h5> seat number: " + seat_number + "</h5><h5> economy? " + is_economy + "</h5><h5> business? " + is_business + "</h5><h5> first? " + is_first 
