...
<%
	...
	ResultSet rs;
	rs = st.executeQuery("select * from ticket_economy_business_first_changes_buys join flight_search_operated_by on flight_search_operated_by.flight_num = ticket_economy_business_first_changes_buys.flight_num order by ticket_economy_business_first_changes_buys.passenger_last");
	...
	if (!rs.next()) {
		...
		do {
			...
			out.println("<h3> last name: " + passenger_last + "</h3>" + " first name: " + passenger_first + " flight number: " + flight_num + " ticket number: " + ticket_number + " account id: " + acc_id + " total_fare: " + total_fare + 
			" purchase date time: " + purchase_date_time + " booking fee: " + booking_fee + " change ticket fee: " + 
			change_ticket_fee + " seat number: " + seat_number + " ticket class: " + ticket_class + " arrival time: " 
