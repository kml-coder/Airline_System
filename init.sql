...
-- account_associates 
INSERT INTO account_associates VALUES ('9999');

-- customer
INSERT INTO customer VALUES ('1234','alice','alice123');
INSERT INTO customer VALUES ('4567','bob','bob123');
INSERT INTO customer VALUES ('7890','charlie','charlie123');

-- customer_rep 
INSERT INTO customer_rep VALUES ('9999','rep01','rep01pass');
INSERT INTO customer_rep VALUES ('9999','rep02','rep02pass');

-- airline_company 
INSERT INTO airline_company VALUES ('DL',5,3);
INSERT INTO airline_company VALUES ('UA',4,2);
INSERT INTO airline_company VALUES ('KE',6,5);

-- airport 
INSERT INTO airport VALUES ('LAX');
INSERT INTO airport VALUES ('ICN');
INSERT INTO airport VALUES ('SFO');

-- aircraft 
INSERT INTO aircraft VALUES ('A320',180);
INSERT INTO aircraft VALUES ('B737',200);
INSERT INTO aircraft VALUES ('B777',350);

-- flight_search_operated_by 
INSERT INTO flight_search_operated_by 
VALUES ('100','DL','1234','08:00:00','05:00:00','2023-12-25','2023-12-24','A320','DAILY',1,'JFK','LAX',0,250,0);

INSERT INTO flight_search_operated_by 
VALUES ('101','UA','4567','15:00:00','12:00:00','2023-12-26','2023-12-25','B737','MWF',0,'LAX','SFO',0,120,0);

INSERT INTO flight_search_operated_by 
VALUES ('102','KE','7890','10:00:00','01:00:00','2023-12-27','2023-12-26','B777','DAILY',0,'ICN','JFK',0,850,1);

-- ticket
INSERT INTO ticket_economy_business_first_changes_buys
VALUES ('T001','1234',300,'DL','Alice','Wonder','2023-12-20 10:00:00',20,0,'12A','economy','100');

INSERT INTO ticket_economy_business_first_changes_buys
VALUES ('T002','4567',450,'UA','Bob','Marley','2023-12-21 11:00:00',30,0,'14C','business','101');

INSERT INTO ticket_economy_business_first_changes_buys
VALUES ('T003','7890',1200,'KE','Charlie','Kim','2023-12-22 15:00:00',50,20,'2A','first','102');

-- waiting_list 
INSERT INTO waiting_list VALUES ('1234','102');
INSERT INTO waiting_list VALUES ('4567','102');

-- question 
INSERT INTO question VALUES ('alice','Can I change my flight date?');
INSERT INTO question VALUES ('bob','Do you provide vegetarian meals?');

-- reply
INSERT INTO reply VALUES ('Yes, you can change up to 24h before departure.','Can I change my flight date?');
INSERT INTO reply VALUES ('Yes, you can request special meals during booking.','Do you provide vegetarian meals?');
